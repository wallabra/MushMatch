...
section link:#building-from-source[*Building from Source*] below.
...
beforehand. You most likely already have `curl`, `zip`, `tar`, `gzip` and `bz2`,
but you'll also need to install a Go package named `mustache`.
...
Therefore, the authors, maintainers, and users of this project should be waived of any liability
or responsibility with regards to that.
...
to notify the author of the project, at the e-mail addressmailto:rehermnan6046@gmail.com[rehermann6046@gmail.com],
